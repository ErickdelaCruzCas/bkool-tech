package com.erick.bkool.repository.config;
...
public class RedisConfig {
    ...
    public RedisCacheManagerBuilderCustomizer redisCacheManagerBuilderCustomizer() {
        return builder -> {
            var bikesCacheConf = RedisCacheConfiguration.defaultCacheConfig()
                    .entryTtl(Duration.ofMinutes(countryNamesEntryTtl));
            builder.withCacheConfiguration(CacheNames.BIKES, bikesCacheConf);
        };
    }
